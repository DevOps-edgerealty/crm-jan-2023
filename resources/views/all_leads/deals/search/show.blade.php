                            ...
                            <div class="col-12 mx-0 px-0">
                                <div class="card">
                                    ...
                                    <div class="card-body" style="position: relative">
                                        ...
                                        {{-- Admin Search --}}
                                        @include('all_leads.deals.search.admin_search')


                                        {{-- Admin Table --}}
                                        @include('all_leads.deals.table.admin')
                                        ...
                                        {{-- Agent Search --}}
                                        @include('all_leads.deals.search.agent_search')


                                        {{-- Agent Table --}}
                                        @include('all_leads.deals.table.agent')
