...
<div class="row mb-5">
    <div class="col-lg-12">
        <form method="GET" action="{{url('/old-leads-re-imbursement/search')}}" enctype="multipart/form-data">
            @csrf
            <div class="mb-3 row">
                <label for="example-text-input" class="col-md-1 offset-md-2 col-form-label">Search</label>
                <div class="col-md-4">
                    <input class="form-control mt-1" name="search" type="text" value="" placeholder="Search Name" id="example-text-input">
                </div>
                <div class="col-md-2">
                    <div class="mb-3 mt-1">
                ...
                <div class="row d-flex justify-content-center">
                        ...
                        <div class="col-md-2 mx-3">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="portal" id="portal"  style="height: 30px; padding-top: 2px !important; padding-bottom: 0px !important;" disabled>
                    ...
                    {{-- <div class="d-flex justify-content-center"> --}}
                        ...
                        <div class="col-md-2 mx-3">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="agent" style="height: 30px; padding-top: 2px !important; padding-bottom: 0px !important;">
            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <button type="submit" class="btn btn-dark w-100" style="background: #000">Search</button>
                </div>
            </div>
