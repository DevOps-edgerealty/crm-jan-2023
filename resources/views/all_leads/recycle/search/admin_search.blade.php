...
<div class="row mb-5">
    <div class="col-lg-12">
        <form method="GET" action="{{url('/all_recycle/search')}}" enctype="multipart/form-data">
            @csrf
            <div class="mb-3 row">
                <label for="example-text-input" class="col-md-1 offset-md-2 col-form-label">Ref. Number</label>
                <div class="col-md-6">
                    ...
                    {{-- <div class="d-flex justify-content-center"> --}}
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <select class="form-select w-100" name="lead_type" id="lead_type" style="height: 30px; padding-top: 2px !important; width: 200px; padding-bottom: 0px !important;">
                        ...
                        <div class="col-md-2 mx-3">
                            <div class="mb-3">
                                ...
                                <select class="form-select w-100" name="lead_source" id="lead_source"  style="height: 30px; padding-top: 2px !important; padding-bottom: 0px !important;" disabled>
                    ...
                    {{-- <div class="d-flex justify-content-center"> --}}
                        ...
                        <div class="col-md-2 mx-3">
                            <div class="mb-3">
                                ...
                                <select class="form-select w-100" name="campaigns" id="campaign-select" style="height: 30px; padding-top: 2px !important; padding-bottom: 0px !important;" disabled>
                        ...
                        <div class="col-md-2 mx-3">
                            <div class="mb-3">
                                ...
                                <select class="form-select w-100" name="agent" style="height: 30px; padding-top: 2px !important; padding-bottom: 0px !important;">
                                    <option value="">Select Agent</option>


                                    @if( isset($request->agent) )
                                        @foreach ($agent as $agents)
                                            @if($agents->id == $request->agent)
                                                <option value="{{ $agents->id}}" selected>Agent: {{ $agents->name }}</option>
                                            @else
