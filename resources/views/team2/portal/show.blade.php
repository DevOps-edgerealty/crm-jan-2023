                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body" style="position: relative">
                                        <h4 class="mb-sm-0 font-size-24">Team Portal Leads</h4>
                                            ...
                                            <div class="table-rep-plugin" >
                                                @include('team.portal.includes.portal_table')
                                            </div>
                                            {{-- /Campaign Table --}}
                                            ...
                                            @foreach ($leads as $lead)
                                                @include('team.portal.includes.portal_modal')
                                            @endforeach
                                            {{-- /Campaign Modal --}}
