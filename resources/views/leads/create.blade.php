                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Create Campgain Lead</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="{{URL('')}}">Home</a></li>
                                            <li class="breadcrumb-item"><a href="{{URL('/leads')}}">Campaign Leads</a></li>
                                            <li class="breadcrumb-item active">Create Campgain Lead</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="{{url('leads/store')}}" enctype="multipart/form-data">
                                            @csrf
                                                ...
                                                <div class="col-md-9">
                                                    <select name="campaign_id" class="form-select" required>
                                                        ...
                                                        @foreach ($campagin as $campagins)
                                                            <option value="{{$campagins->id}}"> {{$campagins->campaign_name}} </option>
                                                        @endforeach
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" name="inquiry" class="form-control" id="horizontal-firstname-input">
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Qualified Question</label>
                                                <div class="col-sm-9">
                                                  <input type="text" name="qualified_ques" class="form-control" id="horizontal-firstname-input">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" name="full_name" class="form-control" id="horizontal-firstname-input">
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="phone" name="phone" class="form-control" id="horizontal-password-input">
                                                </div>
                                            </div>
