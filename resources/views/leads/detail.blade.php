                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Campagin Lead Details</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="{{URL('')}}">Home</a></li>
                                            <li class="breadcrumb-item"><a href="{{URL('/all_leads')}}">All Leads</a></li>
                                            <li class="breadcrumb-item active">Campagin Lead Details</li>
                                        </ol>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Campagin Lead Details</h4>
                                        <div class="table-responsive">
                                            <table class="table table-striped table-nowrap mb-0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>Qualified Question</th>
                                                        <td>{{$leads->qualified_question}}</td>
                                                    </tr>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="my-info-1">
                                                ...
                                                <div class="transferlead hide">
                                                    ...
                                                    <form method="POST" action="{{url('leads/transfer_agent')}}" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="row mb-4">
