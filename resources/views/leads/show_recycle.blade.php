                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Recycle - Campaign Leads</h4>
                                                    ...
                                                    <tbody>
                                                        @foreach ($leads as $lead)
                                                            <tr>
                                                                ...
                                                                <td>{{$lead->inquiry}}</td>
                                                                <td>{{ Str::limit(@$lead->lead_detailss->lead_description, 30) }}</td>
                                                ...
                                                <tbody>
                                                    @foreach ($leads as $lead)
                                                        <tr>
                                                            ...
                                                            <td>{{$lead->lead_typess->type_name}}</td>
                                                            <td>{{$lead->inquiry}}</td>
                                                            <td>{{ Str::limit(@$lead->lead_detailss->lead_description, 120) }}</td>




                                                            <td>
                                                            <a href="{{('leads/transfer/'.$lead->id)}}" class="btn btn-outline-info btn-sm Transfer" title="Transfer">
                                                                <i class="fas fa-sync"> </i>
                                                            </a>
