                                                        ...
                                                        @foreach ($leads as $lead)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="{{('leads/transfer_temporary'.'/'.$lead->id)}}" class="btn btn-outline-warning btn-sm Transfer" title="Reassign Lead">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="row">
                                                                                <div class="col-lg-12">
                                                                                    ...
                                                                                    <form method="POST" action="{{url('leads/temporary/reassign')}}" enctype="multipart/form-data">
                                                                                        @csrf
                                                                                        <div class="row mb-4">
