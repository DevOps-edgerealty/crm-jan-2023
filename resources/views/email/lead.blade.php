    ...
    <tbody>
      <tr>
        ...
        <td>
          ...
          You Have Received A Fresh Lead. Please Check CRM.

        </td>
        <tr>

          <td>To view your lead, login to the CRM using the credentials we have provided at <a href="https://www.crm.edgerealty.ae">crm.edgerealty.ae</a></td>
...
<div>
  <img src="{{URL::asset('public/assets/images/logo-black.png')}}" height="279px" width="106" alt="Edge-Realty-Official-Logo"/>
</div>