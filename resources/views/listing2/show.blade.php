                            ...
                            <div class="col-12">
                                <div class="card shadow-lg p-2" style="background-color: #fcfcfc; border-radius: 10px;">
                                    <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <a href="" class="btn btn-dark waves-effect waves-light me-2">   <i class="fa-solid fa-house"> </i> All ( 509 )</a>
                                                    <a href="" class="btn btn-dark waves-effect waves-light me-2">   <i class="fa-solid fa-circle-plus"> </i> Live ( 298 )</a>
                                                    <a href="" class="btn btn-dark waves-effect waves-light me-2">   <i class="fa-regular fa-floppy-disk"></i> Draft ( 18 )</a>
                                                    <a href="" class="btn btn-dark waves-effect waves-light me-2">   <i class="fa fa-box-archive"></i> Archive ( 266 )</a>
                                                    <a href="" class="btn btn-dark waves-effect waves-light me-2">   <i class="fa-regular fa-eye"> </i> Review ( 0 )</a>
                                                    <a href="{{URL('listing2/customize-listing')}}" class="btn btn-warning text-dark fw-bold waves-effect waves-light me-2">
                                                        <i class="fa fa-cog"> </i>&nbsp;
                                                        Customize Listing
                                                    </a>
                                                    <a href="{{URL('listing2/add-listing/page-one')}}" class="btn btn-dark waves-effect waves-light me-2">
                                            ...
                                            <div id="customizeNewListing" style="display:none;">
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <!-- Community Table -->
                                                    <div class="col-lg-6">
                                                        <div class="card text-light shadow-sm" style="height: 200px">
                                                            <h6 class=" px-3 pt-2 text-secondary">Communities</h6>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="card shadow-sm" style="height: 200px">
                                                            <h6 class=" px-3 pt-2 text-secondary">Developers</h6>
                                                            <div class="table-responsive border border-top-3 bg-white">
                                                                <table class="table table-sm m-0" height="20px">
                                                                    {{-- <thead class="bg-dark text-light">
                                                                        <tr>
