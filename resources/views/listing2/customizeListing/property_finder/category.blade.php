                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <form method="POST" action="{{url('/listing_pf_customize/category/store')}}" enctype="multipart/form-data" class="row needs-validation">
                            ...
                            <div class="col-lg-4">
                                <button type="submit" class="btn btn-dark btn-block form-control">Create category</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="col-md-6">
                        <form method="POST" action="{{url('/listing_pf_customize/property_type/store')}}" enctype="multipart/form-data" class="row needs-validation">
                            ...
                            <div class="col-lg-4">
                                <button type="submit" class="btn btn-dark btn-block form-control w-100">Create Property Type</button>
                            </div>
                        </form>
                    </div>
                </div>
