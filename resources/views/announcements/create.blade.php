                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="{{url('annoucments/store')}}" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" name="announcement" class="form-control" id="horizontal-firstname-input">
                                                </div>
                                            </div>
