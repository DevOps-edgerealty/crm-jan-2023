                                        ...
                                        <div class="row">
                                            ...
                                            <div class="my-info-1">
                                                ...
                                                <div class="notanswering hide">
                                                    ...
                                                    <form method="POST" action="{{url('property_listing_leads/lead_store_detail')}}" enctype="multipart/form-data">
                                                        @csrf
                                                ...
                                                <div class="dealclosed hide">
                                                    <a href="{{URL('property_listing_leads/move_closed/').'/'.$leads->id}}" class="btn btn-success w-md mt-4"><i class="fas fa-check"> </i> Deal Closed</a>
                                                </div>
                                                ...
                                                <div class="recyclelead hide">
                                                    <div class="col-lg-12 mt-4">
                                                        <a href="{{URL('property_listing_leads/move_recycle/').'/'.$leads->id}}" class="btn btn-primary w-md">Move to Recycle</a>

                                                        @if (Auth::user()->user_type == '1')
                                                            <a href="{{URL('property_listing_leads/move_trash/').'/'.$leads->id}}" class="btn btn-danger w-md">  <i class="far fa-trash-alt"> </i> Move to Trash</a>
                                                        @endif
                                                    </div>
