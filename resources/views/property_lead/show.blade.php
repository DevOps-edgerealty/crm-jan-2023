                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body" style="position: relative">
                                        ...
                                        @if (Auth::user()->user_type == '1')
                                            ...
                                            <div class="row mb-5">
                                                <div class="col-lg-12">
                                                    <form method="GET" action="{{url('property_listing/search')}}" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="mb-3 row">
                                                        ...
                                                        <div id="panel">
                                                            ...
                                                            <div class="row" >
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="mb-3">
                                                                        <label for="lead_source" class="form-label">Portals</label>
                                                                        <select class="form-select" name="portals">
                                                                            <option value="">Select Portal</option>
                                                                            @if ($portals)
                                                                                @foreach ($portals as $portal)
                                                                                    <option value="{{ $portal->email}}">{{ $portal->portal_name }}</option>
                                                        ...
                                                        <tbody>
                                                            @foreach ($leads as $lead)
                                                                <tr>
                                                                    ...
                                                                    <td>{{ Str::limit(@$lead->lead_detailss->lead_description, 25) }}</td>
                                                                    ...
                                                                    <td>
                                                                        <a href="{{url('property_listing/detail').'/'. $lead->id }}" class="btn btn-outline-info btn-sm edit">
                                                                            <i class="fas fa-eye"> </i>
                                                                        </a>
                                                                        <a href="{{url('property_listing_leads/edit').'/'. $lead->id }}" class="btn btn-outline-secondary btn-sm edit" title="Edit">
                                                                            <i class="fas fa-pencil-alt"> </i>
