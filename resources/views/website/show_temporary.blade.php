                                                        ...
                                                        @foreach ($website_leads as $lead)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="{{URL('website_leads/transfer_temporary'.'/'.$lead->id)}}" class="btn btn-outline-warning btn-sm Transfer" title="Reassign Lead">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="row">
                                                                                <div class="col-lg-12">
                                                                                    ...
                                                                                    <form method="POST" action="{{url('website_leads/temporary/reassign')}}" enctype="multipart/form-data">
                                                                                        @csrf
                                                                                        <div class="row mb-4">
