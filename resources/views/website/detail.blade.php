                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Website Lead Details</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="{{URL('')}}">Home</a></li>
                                            <li class="breadcrumb-item"><a href="{{URL('/all_leads')}}">All Leads</a></li>
                                            <li class="breadcrumb-item active">Website Lead Details</li>
                                        </ol>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Website Lead Details</h4>
                                        ...
                                        {{-- <div class="row mt-3">
                                            <div class="col-sm-12">
                                                ...
                                                <form method="POST" action="{{url('website_leads/lead_change_status')}}" enctype="multipart/form-data">
                                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <select class="form-select div-toggle" data-target=".my-info-1">
                                                    ...
                                                    <option value="inprogress"  data-show=".inprogress">Interested</option>
                                                    <option value="notinterested"  data-show=".notinterested">Not Interested</option>
                                                ...
                                                <select class="form-select div-toggle" data-target=".my-info-1">
                                                    ...
                                                    <option value="inprogress"  {{ @$leads->lead_detailss->lead_status == 1 ? 'selected' : '' }} data-show=".inprogress">Interested</option>
                                                    <option value="notinterested" {{ @$leads->lead_detailss->lead_status == 2 ? 'selected' : '' }}  data-show=".notinterested">Not Interested</option>
                                                    <!--<option value="transferlead" data-show=".transferlead">Transfer Lead</option>-->
                                                    @if (Auth::user()->team_leader == 1)
                                                        <option value="transferlead" data-show=".transferlead">Transfer Lead</option>
                                                        <option value="recyclelead" data-show=".recyclelead">Recycle Lead</option>
                                            ...
                                            <div class="my-info-1">
                                                ...
                                                <div class="notanswering hide">
                                                    ...
                                                    <form method="POST" action="{{url('website_leads/lead_store_detail')}}" enctype="multipart/form-data">
                                                        @csrf
                                                        ...
                                                        <div class="row mb-4">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <textarea id="formmessage" class="form-control" name="description" rows="3" required></textarea>
                                                ...
                                                <div class="inprogress hide">
                                                    <h4 class="card-title mt-4 mb-4">Lead Details Inrested</h4>
                                                    <div class="table-rep-plugin mb-5">
                                                        <div class="table-responsive mb-0" data-pattern="priority-columns">
                                                        <table id="tech-companies-1" class="table table-striped">
                                                            <thead>
                                                ...
                                                <div class="dealclosed hide">
                                                    <a href="{{URL('website_leads/move_closed/').'/'.$leads->id}}" class="btn btn-success w-md mt-4"><i class="fas fa-check"> </i> Deal Closed</a>
                                                </div>
                                                <div class="transferlead hide">
                                                    ...
                                                    <form method="POST" action="{{url('website_leads/transfer_agent')}}" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="row mb-4">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <select class="form-select" name="user">
                                                                    @if ($users)
                                                                        @foreach ($users as $user)
                                                                            <option {{ ($user->id) == $leads->agent_id ? 'selected' : '' }} value="{{ $user->id}}">{{ $user->name }}</option>
                                                                        @endforeach
                                                                    @endif
                                                                </select>
                                                                {{-- if user is a admin --}}
                                                                ...
                                                                <!--        @endif-->
                                                                <!--    </select>-->
                                                                <!--@elseif (Auth::user()->team_leader == 1 )-->
                                                                <!--    <select class="form-select" name="user">-->
                                                                <!--    @foreach($users as $members)-->
                                                                <!--        @if($members->team_id == Auth::user()->team_id && $members->team_leader == 2)-->
                                                ...
                                                <div class="recyclelead hide">
                                                    <div class="col-lg-12 mt-4">
                                                        <a href="{{URL('website_leads/move_recycle/').'/'.$leads->id}}" class="btn btn-primary w-md">Move to Recycle</a>

                                                        @if (Auth::user()->user_type == '1')
                                                            <a href="{{URL('website_leads/move_trash/').'/'.$leads->id}}" class="btn btn-danger w-md">  <i class="far fa-trash-alt"> </i> Move to Trash</a>
                                                        @endif
                                                    </div>
