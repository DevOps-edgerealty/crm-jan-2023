        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                                <form method="POST" action="{{url('statistics/monthly_ranking_by_month')}}" enctype="multipart/form-data">
                                    @csrf
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        <div class="row">
                                                        ...
                                                        <tbody>
                                                            @foreach ($leader_board as $data => $value)
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div class="avatar-xs me-3">
                                                                                <span class="avatar-title rounded-circle bg-secondary bg-soft text-dark font-size-18">
                                                                                    {{$data+1}}
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <td>
                                                                        <h5 class="font-size-14 mb-1">AED {{$value->totalcommission}}</h5>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <h3 class="text-center">Agents Ranking for the Month of {{$monthName}} {{date('Y');}} </h3>
